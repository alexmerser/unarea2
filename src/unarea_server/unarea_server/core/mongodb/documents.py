...
from unarea_server.core.mongodb.mongo import MongoCollection, MONGODB

__all__ = ["BaseIndexedDocument", "BaseDocument", "ObjectId"]


class BaseDocument(MongoCollection):
    ...
    def __init__(self):
        ...
        super(BaseDocument, self).__init__(
            self.database, self.collection_name, self.structure, self.shortcuts, self.required)
...
class BaseIndexedDocument(BaseDocument):
    ...
    def __init__(self):
        ...
        self.ensure_index(self.indexed_fields)