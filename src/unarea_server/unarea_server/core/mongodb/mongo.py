...
from unarea_server.core.mongodb.exceptions import InvalidKeyValueError, DuplicateKeyError, UnexpectedKeyError
...
class MongoCollection(object):
    ...
    def find_one(self, query, fields=None, sort=None):
        return self.collection.find_one(query, fields=fields, sort=sort)
...
MONGODB = MongoDBObject('unarea_default', 'localhost', 27017)